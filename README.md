...
<!-- After running the visualization, replace this with your actual GIF/image:
![Accident Clip Dashboard](output_accident_003.gif)
-->

> 📍 Place your `output_accident_003.mp4` (or a GIF preview) here.
...
<!-- After running the visualization, replace this with your actual GIF/image:
![Normal Clip Dashboard](output_normal_004.gif)
-->

> 📍 Place your `output_normal_004.mp4` (or a GIF preview) here.
